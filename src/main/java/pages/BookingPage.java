...
//	Locators
	...
	public void Entername() throws InterruptedException {
		...
		explicitWaitOnSendkeys(driver,name,2,"Sambhav");
	}
	public void EnterAddress() throws InterruptedException {
		explicitWaitOnSendkeys(driver,Address,2,"Jain");
	}
	public void EnterCity() throws InterruptedException {
		explicitWaitOnSendkeys(driver,city,2,"Mathura");
	}
	public void EnterState() throws InterruptedException {
		explicitWaitOnSendkeys(driver,state,2,"Uttar Pradesh");
	}
	public void EnterZip() throws InterruptedException {
		explicitWaitOnSendkeys(driver,zip,2,"281403");
	...
	public void EnterCardNumber() throws InterruptedException {
		explicitWaitOnSendkeys(driver,ccn,2,"123456789123");
	...
	public void EnterCardYear() throws InterruptedException {
		explicitWaitOnSendkeys(driver,coy,2,"Ramsingh");

	}
	public void EnterCardName() throws InterruptedException {
		explicitWaitOnSendkeys(driver,cardname,2,"Sambhav Jain");
